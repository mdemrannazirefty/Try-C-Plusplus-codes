...
int main()
{
    ...
    while(first <= last)
    {
        ...
        else if(a[mid]==num)
        {
            ...
            //print all elements greater than or equal
            cout << "Elements greater than or equal to "<<num << ": ";
                for (int i = 0; i < n; i++)
                {
                    if (a[i] >= num)
                    {
                ...
                cout <<endl;
                //print all elements less than or equal
                cout << "Elements less than or equal to "<<num <<": ";
                    for (int i = 0; i < n; i++)
                        {
                            if (a[i] <= num)
                            {
